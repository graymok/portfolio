...
const Projects = () => {
    ...
    const kyberDescription = "Kyber Parker is a boutique, direct-to-consumer company that sells reclaimed kyber crystals to force wielders looking to craft a high-quality lightsaber. Completed in 7 days on 5/18/21 as the final project for "
    ...
    const wrkpointDescription = "Wrkpoint is an enterprise solution for managing work space reservations and supporting unique employee work styles. Completed in 5 days on 5/5/21 as the third project for "
    ...
    const zeitgeistDescription = "Zeitgeist is a personal news aggregator, allowing users to search for news from a country origin of their choice and to bookmark interesting articles. Completed in 5 days on 4/14/21 as the second project for "
